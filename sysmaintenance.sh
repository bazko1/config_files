...
# https://raw.githubusercontent.com/kurealnum/dotfiles/refs/heads/main/.config/scripts/sysmaintenance.sh 
...
echo "Clearing ~/.cache"
yay -Sc
# Removing all cache leads to unpleasant experience with some programs like fzf
