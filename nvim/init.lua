...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>rs', builtin.resume, { desc = 'Search [R]e[s]ume' })
  ...
  -- LSP Plugins
  {
    -- `lazydev` configures Lua LSP Neovim config, runtime and plugins
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gD', ":vs | lua require('telescope.builtin').lsp_definitions()<CR>", '[G]oto [D]efinition split')
          ...
          -- word under your cursor when cursor rests there for a little while.
